...
Special thanks to Keyser and JaggedAppliance for creating the balance test mod and their contribution to the balance team, Icedreamer and Exotic\_Retard for assisting with coding and to the whole balance testing team for alpha testing all changes.
...
We are fixing Aeon TMD so its no longer possible to shoot missiles over it and hit targets behind the TMD. Thanks to Exotic\_Retard for the code for this.
